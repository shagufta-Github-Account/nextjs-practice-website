...
// Mock product data with spaces removed from image URLs
    ...
    <section className="px-12 py-6 container mx-auto">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-4">
          <Badge className="px-3 py-1 text-md bg-red-500 text-white rounded-sm">
            Featured Products
          </Badge>
      ...
      <Carousel
        ...
        setApi={(api) => {
          if (api) {
            ...
            if (prevBtn) prevBtn.onclick = () => api.scrollPrev()
            if (nextBtn) nextBtn.onclick = () => api.scrollNext()
          }
        }}
      >
        <CarouselContent>
...
//       <div className="flex items-center justify-between mb-4">
//         <div className="flex items-center gap-4">
//           <Badge className="px-3 py-1 text-sm bg-red-500 text-white rounded-sm">Featured Products</Badge>
//           <h2 className="text-3xl font-bold tracking-tight">Trending Now</h2>
//         </div>
//         <div className="hidden md:flex items-center gap-2">
